...
@pytest.mark.parametrize(("pattern", 'mismatches', 'exphits', 'GENOME_PATH', "output_folder"), [
    (b'TGGATGTGAAATGAGTCAAG', 3, 'data/TGGATGTGAAATGAGTCAAG-results.sam', 'data/Homo_sapiens.GRCh38.dna.primary_assembly.fa.gz', "./results/"),
    (b'GGGTGGGGGGAGTTTGCTCC', 3, 'data/vegfa-site1-results.sam', 'data/Homo_sapiens.GRCh38.dna.primary_assembly.fa.gz', "./results/"),
])
